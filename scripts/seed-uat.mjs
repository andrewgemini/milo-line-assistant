...
try {
 ...
 await insert('vault_items',{lineChatId:owner,createdByLineUserId:owner,itemType:'link',title:'[UAT] คู่มือไมโล',sourceUrl:'https://milo-line-assistant.onrender.com',searchableText:'UAT ลิงก์ไมโล',tagsText:'UAT'});
