  ...
  return (
    <div className={`relative ${sizes[size]} ${className}`} aria-label="ไมโล แมวผู้ช่วย AI">
      <style>{`
        ...
        @keyframes miloManeki {
          0%, 100% { transform: translate3d(0, 3px, 0) rotate(-26deg); }
          25% { transform: translate3d(2px, -5px, 0) rotate(20deg); }
          50% { transform: translate3d(0, -8px, 0) rotate(48deg); }
          75% { transform: translate3d(-2px, -4px, 0) rotate(16deg); }
        }
        ...
        .milo-maneki-paw {
          animation: miloManeki 0.82s ease-in-out infinite;
      ...
      <div className="milo-art-float relative h-full w-full">
        <div className="milo-art-glow pointer-events-none absolute inset-[5%] rounded-full bg-[#8ee6b8] blur-2xl" aria-hidden="true" />
        <svg viewBox="0 0 420 420" className="relative z-10 h-full w-full overflow-visible drop-shadow-xl" role="img" aria-label="ไมโล แมวกวักญี่ปุ่นยืนโบกมือเรียกแขก">
          <defs>
            <radialGradient id="miloCircle" cx="50%" cy="42%" r="58%"><stop offset="0" stopColor="#effff5"/><stop offset=".78" stopColor="#d6f8df"/><stop offset="1" stopColor="#b8edc8"/></radialGradient>
            <linearGradient id="miloBody" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#fffdfb"/><stop offset="1" stopColor="#eeeae6"/></linearGradient>
            <linearGradient id="miloScarf" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#18bd79"/><stop offset="1" stopColor="#078c61"/></linearGradient>
          </defs>
          <circle cx="210" cy="210" r="190" fill="url(#miloCircle)" stroke="#73d79b" strokeWidth="8" />
          <circle cx="210" cy="210" r="177" fill="none" stroke="#effff5" strokeWidth="5" />
          <g className="milo-standing-cat">
            ...
            <path d="M145 242 C132 274 127 320 134 351 C139 376 161 381 184 367 L238 367 C261 382 285 371 289 346 C293 312 283 271 268 242 Z" fill="url(#miloBody)" stroke="#3c2925" strokeWidth="7" />
            <path d="M153 258 C176 279 237 279 261 255 L267 288 C244 305 176 304 150 286 Z" fill="url(#miloScarf)" stroke="#3c2925" strokeWidth="5" />
